...
const renderingModeIntro = trans('The core of Mint Stylus is writing Markdown, which can be shown using either its raw syntax, or in a WYSIWYG mode. Which one do you prefer?')
