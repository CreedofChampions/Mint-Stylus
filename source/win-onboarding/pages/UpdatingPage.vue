...
const updatesIntro = trans('Mint Stylus will from time to time check for updates. If you installed Mint Stylus via a package manager (e.g., APT or Pacman, Homebrew, or winget or chocolatey), you should turn this off.')
