...
Mint Stylus supports split views to make your work more productive. We have provided you with a sample layout using three editor panes (one left and two vertically stacked on the right) to demonstrate this functionality. You can drag and drop files to create new splits. Here's how it works:
...
* Mint Stylus also supports multiple windows. Press `Cmd/Ctrl+Shift+N` to open new windows