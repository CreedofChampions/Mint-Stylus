...
# Citing with Mint Stylus 💬

In this final guide, we will dive into how you can automatically cite using Mint Stylus! If you have been using the Zotero plugin for Word before (or even the Citavi plugin), rest assured: It works almost the same, but you have much more freedom to adapt the citations to your needs.

To begin citing with Mint Stylus, you’ll need to set up a references database, [which we describe in our documentation](https://docs.zettlr.com/en/editor/citations/). For the purposes of this tutorial, we have already prepared a small database which’ll cover everything you need to know. Let’s load it! In the tutorial directory, there is a small file called “references.json”. It contains some references that Mint Stylus can cite. To load it, first head over into the preferences and into the tab “Citations”. Once there, navigate to the file using the file browser of the references database-field.

## Your First Citation 🎓

Mint Stylus will immediately load the file and you’re able to cite. Let’s have a look at the following blockquote, which certainly needs a citation:
...
Finally, if you want to, you can also support Mint Stylus on [Patreon](https://www.patreon.com/zettlr) or via [PayPal](https://www.paypal.me/hendrikerz)!

But now we're done with this little introduction: **Enjoy working with Mint Stylus!**
