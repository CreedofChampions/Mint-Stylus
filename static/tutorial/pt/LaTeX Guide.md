...
* macOS: [MacTex](https://www.tug.org/mactex/morepackages.html) (_Basta instalar o Basic Tex, que é muito menor do que a versão completa!_)
* Linux: [TeX Live](https://www.tug.org/texlive/) (instale o pacote `texlive-base`. Você também pode precisar instalar o pacote `texlive-xetex`)
