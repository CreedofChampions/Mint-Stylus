---
title: "Trabalhando com Zettelkästen"
keywords:
  - Zettelkasten
  - Zettel
...
Mas criar links não é a única forma de relacionar notas. Você também pode usar tags para isso. Tags funcionam exatamente como hashtags no Twitter, então você pode #criar #hashtags #tanto #quanto #quiser! Clicar em `Cmd/Ctrl` nessas tags também iniciará uma busca e destacará todos os arquivos que contêm essa tag.

Há também uma nuvem de tags à qual você pode acessar clicando no ícone de “tag” na barra de ferramentas. Ela listará todas as suas tags e indicará o número de arquivos que a usam. Você pode filtrar e gerenciar suas tags a partir daí. Enquanto os links do Zettelkasten criam conexões “fortes” entre os arquivos, as tags são uma espécie de conexão “difusa” entre conteúdos relacionados e podem atender melhor ao seu fluxo.

## Considerações finais 💭

Não vamos abordar aqui métodos para trabalhar efetivamente com um Zettelkasten, porque existem muitos tutoriais que podem ajudá-lo a começar. Aqui está uma lista útil de bons tutoriais:

- [Uma primeira introdução pode ser encontrada em nossa documentação](https://docs.zettlr.com/en/pkms/zkn-method/)
- [Sobre o conceito de Zettelkasten, leia nosso blog](https://zettlr.com/post/what-is-a-zettelkasten)
- [A página zettelkasten.de (em inglês) contém muitos artigos sobre Zettelkästen](https://zettelkasten.de/)
- [O Reddit tem um subreddit dedicado exclusivamente à arte do Zettelkasten](https://www.reddit.com/r/Zettelkasten)
